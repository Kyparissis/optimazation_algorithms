%   This function implements the Newton optimization method
...
%%
function [FinalPoints, maxIterations, x_values, y_values] = Newton_method(f, InitialPoints, epsilon, stepSwitchText, stepSwitchChoise, stepValue)
...
%         % DEBUGGING
%         % Check if Hessian matrix is positive difinite
%         % ----------------------
%         fprintf("\nIteration #%d\n", k);
%         fprintf("============\n");
%         if (all(eig(H) > 0) ~= 1)
%             fprintf("Hessian not positive definite\n");
%             double(eig(H))
%         end
